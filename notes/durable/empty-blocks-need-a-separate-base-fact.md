...
[FACT, 2026-09-03] **The hole.** Every "whole block" property in the
...
[FACT, 2026-09-03] **Instance 1 — the mother lemma.** `ptrChain_lowering_sim`
...
(Added 2026-08-31 during the chain-dst subsumption; the ZST-referent gap
was found by a leaf that could not discharge `h_drange` at all.)

[FACT, 2026-09-03] **Instance 2 — regime B for copy.** The address rename
...
[FACT, 2026-09-03] **Why const_write did not need this and copy did.**
...
[FACT, 2026-09-03] **Rejected alternative:** widening the range to
...
[FACT, 2026-09-03] The extension needs NO freshness side condition
...
- journal/2026-09-03-copy-fresh-dst.md — the increment that added
  `extendBlock`
