# 2026-09-03 — ZST addresses, extendBlock's shape, wildcard provenance
...
[OBS 2026-09-03] **Q: what decision did `extendBlock` encode?** Answer
...
[OBS 2026-09-03] **Q: two allocations can start at the same address —
...
[OBS 2026-09-03] **Q: does a raw-pointer local have a unique tag?**
Answer distilled to
...
[OBS 2026-09-03] Side finding while writing the above: the v2 durable
...
- journal/2026-09-03-copy-fresh-dst.md — the increment that introduced
